...
export const usersApi = {
  ...
  publicConfig: () => api.get<{ gift_wrap_price: string; bnpl?: { enabled: boolean; provider: string; parts: number; min_order: string } }>('/users/public-config').then(r => r.data),
...
export const ordersApi = {
  ...
  installmentPlan: (id: number) => api.get<any>(`/orders/${id}/installment-plan`).then(r => r.data),
