      ...
      <Alert
        ...
        description={
          <ul style={{ marginBottom: 0, paddingLeft: 20 }}>
            ...
            <li>Если друг — покупатель: после его первой покупки вы получите бонусные баллы — процент от суммы его покупки</li>
            <li>Если друг — продавец: после его первой продажи вы получите вознаграждение на баланс — процент от суммы продажи</li>
