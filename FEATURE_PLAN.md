...
## Блок 1 — KYC и бейджи доверия продавца [TODO]
...
## Блок 2 — Email/Push-кампании (сегменты + рассылки) [TODO]
...
## Блок 3 — Мультипользовательские аккаунты магазина (сотрудники) [TODO]
...
## Блок 4 — Мультидоставка (Почта России / Ozon / Яндекс) [TODO]
...
## Блок 5 — Кэш (Redis) + оптимизация изображений + наблюдаемость [В РАБОТЕ — делаем первым]
...
## Блок 6 — Мультиязычность (i18n), английский + переключатель [TODO]
...
## Блок 7 — Метрики Grafana по всему проекту [TODO]
